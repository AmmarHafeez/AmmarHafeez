...
I build data pipelines, analytics-ready datasets and applied ML systems with a focus on reproducibility, data quality and clear evaluation. My background combines software engineering, time-series data, signal preprocessing, privacy-aware machine learning and local-first system design.
